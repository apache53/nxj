...
CREATE TABLE `scenic` (
  ...
  `latitude2` decimal(10,6) DEFAULT '0' COMMENT '纬度，范围为-90~90，负数表示南纬',
  `longitude2` decimal(10,6) DEFAULT '0' COMMENT '经度，范围为-180~180，负数表示西经',
  `latitude3` decimal(10,6) DEFAULT '0' COMMENT '纬度，范围为-90~90，负数表示南纬',
  `longitude3` decimal(10,6) DEFAULT '0' COMMENT '经度，范围为-180~180，负数表示西经',
